        ...
        <>
            <TouchableOpacity style={styles.card} onPress={openEdit} activeOpacity={0.7}>
                ...
                <View style={styles.weightBarBg}>
                    <View style={[styles.weightBarFill, { width: `${Math.max(decayedWeight * 100, 5)}%` }]} />
                </View>
...
const styles = StyleSheet.create({
    card: { backgroundColor: '#fff', borderRadius: 8, padding: 12, marginBottom: 8, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 4, elevation: 3 },
    ...
    weightBarBg: { height: 3, backgroundColor: '#f0f0f0', borderRadius: 2, marginBottom: 8 },
    weightBarFill: { height: 3, borderRadius: 2, backgroundColor: '#6C63FF' },
