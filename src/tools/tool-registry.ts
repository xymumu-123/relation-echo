import { ToolDefinition } from '../api/llm-client';
...
class ToolRegistry {
    ...
    getToolDefinitions(): ToolDefinition[] {
        return this.getSafeTools().map(tool => ({
            type: 'function' as const,
            function: {
                name: tool.name,
                description: tool.description,
                parameters: { type: 'object', properties: tool.parameters, required: Object.keys(tool.parameters) },
            },
        }));
    }
